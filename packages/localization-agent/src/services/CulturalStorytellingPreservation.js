...
exports.CulturalStorytellingPreservation = void 0;
class CulturalStorytellingPreservation {
     ...
     */
    async createCulturalCelebrationTemplates(celebrations, culturalCommunityInput = {}) {
    ...
    async getNarrativeStructureForCulture(culture) {
    ...
    async getOralTraditionPattern(culture, storyContent) {
    ...
    async getIndigenousMethod(group, culturalLiaison) {
    ...
    buildNarrativeStructurePrompt(modernStory, traditionalStructure, targetAudience) {
        return `
...
Respond with JSON format:
{
  ...
  "preservationAchieved": ["how this helps preserve the tradition"]
    ...
    buildMythologyIntegrationPrompt(mythology, culturalOrigin, modernStoryContext) {
        return `
...
Respond with JSON format:
{
  ...
  "childFriendlyVersions": [
    ...
    buildCelebrationTemplatePrompt(celebrations, culturalCommunityInput) {
        return `
Create cultural celebration story templates with community input:
...
Respond with JSON format:
{
  ...
  "educationalValue": ["overall educational benefits"]
    ...
    buildCommunityDocumentationPrompt(community, geographicOrigin) {
        return `
...
Respond with JSON format:
{
  ...
  "integrationStrategies": {
    ...
    buildTraditionDocumentationPrompt(tradition, culturalContext, communityCollaboration) {
        return `
...
Respond with JSON format:
{
  ...
  "accessibilityConsiderations": {
    ...
    buildCulturalValidationPrompt(adaptation, originalTradition, culturalContext, communityReview) {
        return `
...
exports.CulturalStorytellingPreservation = CulturalStorytellingPreservation;
//# sourceMappingURL=CulturalStorytellingPreservation.js.map