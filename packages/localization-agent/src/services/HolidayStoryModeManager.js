...
exports.HolidayStoryModeManager = void 0;
class HolidayStoryModeManager {
     ...
     */
    async generateHolidayCharacterVariations(baseCharacter, holiday, culturalContext) {
        try {
     ...
     */
    async createHolidayActivities(holiday, culturalContext, userAge, storyTheme) {
        try {
    ...
    async getHolidayMode(holiday, culturalContext, userAge) {
    ...
    async getMonthlyHolidays(culturalContexts) {
    ...
    buildHolidayStoryPrompt(request, holidayMode) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "familyDiscussionPoints": ["questions and topics for family discussion"]
    ...
    buildHolidaySuggestionPrompt(culturalContext, currentDate, userAge) {
        return `
...
[
  {
    ...
    buildMulticulturalHolidayPrompt(holidays, culturalContexts, userAge, theme) {
        return `
...
Please respond with the same JSON structure as a regular holiday story, but incorporating multiple cultural traditions.
    ...
    buildHolidayCharacterPrompt(baseCharacter, holiday, culturalContext) {
        return `
...
[
  {
    ...
    buildHolidayActivityPrompt(holiday, culturalContext, userAge, storyTheme) {
        return `
...
exports.HolidayStoryModeManager = HolidayStoryModeManager;
//# sourceMappingURL=HolidayStoryModeManager.js.map