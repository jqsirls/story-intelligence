...
exports.CulturalIntelligenceEngine = void 0;
class CulturalIntelligenceEngine {
     ...
     */
    async integrateStorytellingTraditions(traditions, modernStoryContext, targetAudience) {
     ...
     */
    async getCulturalCelebrations(culturalBackground, timeframe) {
        const celebrations = [];
        for (const culture of culturalBackground) {
     ...
     */
    async generateCrossCulturalInteraction(cultures, interactionType, storyContext, ageGroup) {
     ...
     */
    async createReligiousSensitivityEngine(religiousContexts, customFilters) {
        const filters = [];
        const guidelines = [];
     ...
     */
    async analyzeCulturalContext(storyContent, targetCultures, sensitivityLevel = 'medium') {
    ...
    async analyzeIndividualElement(element, targetCultures, storyContext) {
        const prompt = `
...
Respond in JSON format with the structure:
{
  ...
  "culturalSpecificAdaptations": {
    ...
    async getSymbolsForCulture(culture) {
    ...
    async getArchetypesForCulture(culture) {
    ...
    async getCelebrationsForCulture(culture, timeframe) {
        // This would typically query a comprehensive celebrations database
        const celebrationDatabase = {
            'chinese': [
                {
    ...
    async createReligiousFilter(religiousContext, customFilters) {
    ...
    getReligiousGuidelines(religiousContext) {
        const guidelines = {
            'islamic': [
    ...
    buildTraditionIntegrationPrompt(traditions, modernStoryContext, targetAudience) {
        return `
...
Respond with JSON format:
{
  ...
  "culturalRespect": ["ways cultural respect was maintained"]
    ...
    buildCrossCulturalInteractionPrompt(cultures, interactionType, storyContext, ageGroup) {
        return `
...
Respond with JSON format:
{
  ...
  "respectfulExchange": ["examples of respectful cultural exchange"]
    ...
    buildCulturalAnalysisPrompt(storyContent, targetCultures, sensitivityLevel) {
        return `
...
exports.CulturalIntelligenceEngine = CulturalIntelligenceEngine;
//# sourceMappingURL=CulturalIntelligenceEngine.js.map