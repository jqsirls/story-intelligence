...
exports.CrossCulturalInteractionEngine = void 0;
class CrossCulturalInteractionEngine {
    constructor(openai) {
        this.openai = openai;
    }
    /**
     ...
     */
    async createMisunderstandingScenario(cultures, misunderstandingType, ageGroup) {
        try {
     ...
     */
    async generateCollaborativeScenario(cultures, problemType, ageGroup) {
        try {
     ...
     */
    async createCelebrationIntegrationScenario(primaryCelebration, primaryCulture, participatingCultures, ageGroup) {
        try {
            const celebrationPrompt = this.buildCelebrationIntegrationPrompt(primaryCelebration, primaryCulture, participatingCultures, ageGroup);
            const completion = await this.openai.chat.completions.create({
                model: process.env.OPENAI_MODEL || 'gpt-5.1',
                messages: [
                    {
     ...
     */
    async generateEmpathyBuildingExercise(cultures, focusArea, ageGroup) {
        try {
    ...
    buildFriendshipScenarioPrompt(cultures, ageGroup, setting) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "resolutionStrategies": ["positive ways to strengthen cross-cultural friendships"]
    ...
    buildCulturalBridgePrompt(cultures, commonTheme, storyContext) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "conflictResolution": ["how cultural differences are resolved positively"]
    ...
    buildCulturalExchangePrompt(cultures, activityType, ageGroup) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "ageAdaptations": {
    ...
    buildMisunderstandingScenarioPrompt(cultures, misunderstandingType, ageGroup) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "empathyBuilding": ["how this builds empathy and understanding"]
    ...
    buildCollaborativeScenarioPrompt(cultures, problemType, ageGroup) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "valuesDemonstrated": ["values demonstrated through collaboration"]
    ...
    buildCelebrationIntegrationPrompt(primaryCelebration, primaryCulture, participatingCultures, ageGroup) {
        return `
...
Please respond with a JSON object containing:
{
  ...
  "culturalSensitivities": ["important cultural considerations to respect"]
    ...
    buildEmpathyBuildingPrompt(cultures, focusArea, ageGroup) {
        return `
...
exports.CrossCulturalInteractionEngine = CrossCulturalInteractionEngine;
//# sourceMappingURL=CrossCulturalInteractionEngine.js.map