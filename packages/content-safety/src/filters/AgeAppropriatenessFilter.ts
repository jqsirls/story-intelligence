...
export class AgeAppropriatenessFilter implements PreGenerationFilter {
  ...
  private checkToddlerContent(content: string): { inappropriate: boolean; warnings: string[] } {
    const warnings: string[] = [];
  ...
  private checkEarlyChildhoodContent(content: string): { inappropriate: boolean; warnings: string[] } {
    const warnings: string[] = [];
    let inappropriate = false;
  ...
  private checkMiddleChildhoodContent(content: string): { inappropriate: boolean; warnings: string[] } {
    const warnings: string[] = [];
    let inappropriate = false;
  ...
  private checkTeenContent(content: string): { inappropriate: boolean; warnings: string[] } {
    const warnings: string[] = [];
    let inappropriate = false;
  ...
  private checkVocabularyComplexity(content: string, age: number): { tooComplex: boolean; warnings: string[] } {
    const warnings: string[] = [];
  ...
  private checkSentenceComplexity(content: string, age: number): { tooComplex: boolean; warnings: string[] } {
    const warnings: string[] = [];
    let tooComplex = false;
  ...
  private checkEmotionalComplexity(content: string, age: number): { inappropriate: boolean; warnings: string[] } {
    const warnings: string[] = [];
    let inappropriate = false;
  ...
  private getMaxWordLength(age: number): number {
    if (age < 5) return 6;
    if (age < 8) return 8;
    if (age < 13) return 10;
    return 12;
