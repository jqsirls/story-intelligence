...
export class MetricsCollector {
   ...
   */
  private async getEventSystemMetrics(): Promise<SystemMetrics['eventSystem']> {
    try {
  ...
  private async getAgentMetrics(): Promise<SystemMetrics['agents']> {
    try {
      ...
      const agentMetrics: SystemMetrics['agents'] = {};
   ...
   */
  private async sendToDatadog(metrics: SystemMetrics): Promise<void> {
    if (!this.config.datadogApiKey) {
      return;
    }
