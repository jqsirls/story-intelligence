...
export class MultiModalInputProcessor {
  ...
  async processInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process multi-modal input: ${error.message}`, { userId, sessionId, inputType: inputData.type });
    }
  }
  ...
  async getInputHistory(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to get input history: ${error.message}`, { userId, sessionId });
    }
  }
  ...
  async getInputPatterns(userId: string): Promise<{
    ...
    try {
      ...
      throw new AdaptationError(`Failed to get input patterns: ${error.message}`, { userId });
    }
  }
  ...
  private async processVoiceInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process voice input: ${error.message}`, { data });
    }
  }
  ...
  private async processTouchInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process touch input: ${error.message}`, { data });
    }
  }
  ...
  private async processGestureInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process gesture input: ${error.message}`, { data });
    }
  }
  ...
  private async processSwitchInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process switch input: ${error.message}`, { data });
    }
  }
  ...
  private async processEyeTrackingInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process eye tracking input: ${error.message}`, { data });
    }
  }
  ...
  private async processCombinedInput(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process combined input: ${error.message}`, { data });
    }
  }
