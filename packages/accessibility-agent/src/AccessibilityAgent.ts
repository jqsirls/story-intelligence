...
export class AccessibilityAgent {
  ...
  async createAccessibilityProfile(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to create accessibility profile: ${error.message}`, { userId, error });
    }
  }
  ...
  async getAccessibilityProfile(userId: string): Promise<AccessibilityProfile | null> {
    try {
      ...
      throw new AdaptationError(`Failed to get accessibility profile: ${error.message}`, { userId, error });
    }
  }
  ...
  async updateAccessibilityProfile(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to update accessibility profile: ${error.message}`, { userId, error });
    }
  }
  ...
  async processWithSpeechDelay(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to process speech delay: ${error.message}`, { userId, error });
    }
  }
  ...
  async learnVocabularyPreference(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to learn vocabulary preference: ${error.message}`, { userId, error });
    }
  }
  ...
  async checkEngagement(
    ...
    try {
      ...
      if (error instanceof ProfileNotFoundError) throw error;
      throw new AdaptationError(`Failed to check engagement: ${error.message}`, { userId, error });
    }
  }
  ...
  async recordEngagementMetrics(
    ...
    try {
      ...
      throw new AdaptationError(`Failed to record engagement metrics: ${error.message}`, { userId, error });
    }
  }
  ...
  async registerAssistiveTechnology(
    ...
    try {
      ...
      throw new AssistiveTechnologyError(`Failed to register assistive technology: ${error.message}`, { userId, error });
    }
  }
  ...
  async getAssistiveTechnologies(userId: string): Promise<AssistiveTechnology[]> {
    try {
      ...
      throw new AssistiveTechnologyError(`Failed to get assistive technologies: ${error.message}`, { userId, error });
    }
  }
  ...
  async testAssistiveTechnology(
    ...
    try {
      ...
      throw new AssistiveTechnologyError(`Failed to test assistive technology: ${error.message}`, { userId, error });
    }
  }
  ...
  async processMultiModalInput(
    ...
    try {
      ...
      if (error instanceof ProfileNotFoundError) throw error;
      throw new AdaptationError(`Failed to process multi-modal input: ${error.message}`, { userId, error });
    }
  }
  ...
  async generateAccessibilityReport(userId: string): Promise<{
    ...
    try {
      ...
      throw new AdaptationError(`Failed to generate accessibility report: ${error.message}`, { userId, error });
    }
  }
  ...
  async getAccessibilityInsights(userId: string, timeRange?: { start: Date; end: Date }): Promise<{
    ...
    try {
      ...
      throw new AdaptationError(`Failed to get accessibility insights: ${error.message}`, { userId, error });
    }
  }
