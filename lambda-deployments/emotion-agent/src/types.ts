...
// Re-export new sophisticated analysis types
export type { 
  VoicePatternAnalysis, 
  VoiceCharacteristics, 
  EmotionalMarker, 
  StressIndicator 
} from './services/VoicePatternAnalyzer';
...
export type { 
  ...
  FatigueIndicator, 
  EngagementPattern 
} from './services/ResponseLatencyAnalyzer';

export type { 
  StoryChoice, 
  ChoicePattern, 
  EmotionalChoiceCorrelation, 
  LongitudinalTrend 
} from './services/StoryChoicePatternAnalyzer';
...
export type { 
  ...
  RiskFactor 
} from './services/LongitudinalTrendTracker';

export type {
  EarlyInterventionSignal,
  InterventionIndicator,
  RiskAssessment,
  RiskFactor as EarlyRiskFactor,
  ProtectiveFactor,
  InterventionRecommendation,
  PredictiveModel,
  ModelPrediction
} from './services/EarlyInterventionDetector';

export type {
  StoryRecommendation,
  StoryAdaptation,
  MoodBasedRecommendationContext,
  MoodHistoryEntry,
  SessionContext,
  UserPreferences,
  TherapeuticStoryPathway,
  TherapeuticStoryStep,
  AdaptationTrigger,
  EmotionalJourney,
  JourneyProgress,
  JourneyAdaptation,
  JourneyOutcome
} from './services/MoodBasedStoryRecommendationEngine';
...
export type {
  ...
  FollowUpSchedule,
  SafetyPlan
} from './services/CrisisEscalationProtocol';
