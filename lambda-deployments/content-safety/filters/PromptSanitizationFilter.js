...
exports.PromptSanitizationFilter = void 0;
class PromptSanitizationFilter {
    constructor(openai, logger) {
        this.name = 'prompt_sanitization';
        this.priority = 100;
        this.enabled = true;
        this.openai = openai;
        this.logger = logger;
...
exports.PromptSanitizationFilter = PromptSanitizationFilter;
//# sourceMappingURL=PromptSanitizationFilter.js.map