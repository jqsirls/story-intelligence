...
exports.ContextualSafetyAnalyzer = void 0;
class ContextualSafetyAnalyzer {
    constructor(openai, logger) {
        this.openai = openai;
        this.logger = logger;
    }
    async analyzeContextualSafety(content, userAge, contentType) {
...
exports.ContextualSafetyAnalyzer = ContextualSafetyAnalyzer;
