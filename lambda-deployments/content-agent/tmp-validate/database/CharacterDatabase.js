...
class CharacterDatabase {
    constructor(supabaseUrl, supabaseKey, logger) {
        this.tableName = 'user_characters';
    ...
    async createCharacter(character) {
        try {
            const { data, error } = await this.supabase
                ...
                bodyshot_url: character.bodyshotUrl,
                bodyshot_prompt: character.bodyshotPrompt,
     ...
     */
    async getCharactersByUser(userId, filter) {
        try {
    ...
    async updateCharacter(characterId, updates) {
        try {
            ...
            if (updates.traits)
                updateData.traits = updates.traits;
            if (updates.headshotUrl)
                updateData.headshot_url = updates.headshotUrl;
            if (updates.elevenLabsVoiceId)
                updateData.elevenlabs_voice_id = updates.elevenLabsVoiceId;
            if (updates.hedraAvatarId)
                updateData.hedra_avatar_id = updates.hedraAvatarId;
     ...
     */
    async incrementUsageCount(characterId) {
        try {
