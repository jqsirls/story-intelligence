...
exports.SAFETY_RATING_CRITERIA = void 0;
exports.buildSafetyReviewPrompt = buildSafetyReviewPrompt;
exports.isRatingAcceptable = isRatingAcceptable;
/**
 * Complete safety rating criteria with explicit examples
 */
exports.SAFETY_RATING_CRITERIA = {
    'G': {
 ...
 */
function buildSafetyReviewPrompt(targetRating, characterName) {
    const criteria = exports.SAFETY_RATING_CRITERIA[targetRating];
 ...
 */
function isRatingAcceptable(rating, targetRating) {
