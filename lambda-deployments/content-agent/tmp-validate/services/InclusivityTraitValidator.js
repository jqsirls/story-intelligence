...
exports.InclusivityTraitValidator = void 0;
const models_1 = require("../config/models");
class InclusivityTraitValidator {
    constructor(openai, logger, visionModel = models_1.MODEL_CONFIG.VISION) {
        this.openai = openai;
        this.logger = logger;
     ...
     */
    async validateTraitsPresent({ imageB64, expectedTraits, characterName }) {
...
Return STRICT JSON:
{
  ...
  "suggestedRetryPrompt": "If traits missing, what MANDATORY language to add for retry to force AI compliance"
        ...
        try {
            ...
            if (!result.allTraitsPresent) {
                this.logger.warn('AI BIAS DETECTED - Traits missing from generated image', {
                    characterName,
                    missingTraits: result.missingTraits,
                    traitsVisible: result.traitsVisible.filter((t) => !t.visible)
                });
            }
            return result;
        }
     ...
     */
    buildIntensifiedPrompt(missingTraits, attempt) {
        const sections = [
...
exports.InclusivityTraitValidator = InclusivityTraitValidator;
