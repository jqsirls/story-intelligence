...
class VoiceRemixingService {
    constructor(logger, apiKey) {
        ...
        if (!this.elevenLabsApiKey) {
            this.logger.warn('ElevenLabs API key not configured, voice remixing features will be disabled');
        }
    }
    /**
    ...
    async remixVoice(request) {
        ...
        if (!this.elevenLabsApiKey || this.elevenLabsApiKey === 'placeholder') {
            this.logger.warn('ElevenLabs API key not configured, cannot remix voice');
