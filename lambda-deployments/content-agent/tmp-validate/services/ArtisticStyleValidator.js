...
exports.ArtisticStyleValidator = void 0;
class ArtisticStyleValidator {
    constructor(openai, logger, visionModel) {
        this.openai = openai;
        this.logger = logger;
     ...
     */
    async validateStyle({ imageB64, characterName }) {
...
Return STRICT JSON:
{
  ...
  "suggestedStyleFix": "If photorealistic, specific directives to make it painterly illustrated"
     ...
     */
    buildIntensifiedStylePrompt(attempt) {
        if (attempt === 1) {
            return `
...
exports.ArtisticStyleValidator = ArtisticStyleValidator;
