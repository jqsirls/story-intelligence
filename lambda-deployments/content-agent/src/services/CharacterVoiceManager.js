...
class CharacterVoiceManager {
    ...
    initializeVoiceLibrary() {
        return {
            frankieVoice: {
                ...
                voiceId: 'kQJQj1e9P2YDvAdvp2BW', // Frankie's voice ID
                voiceSettings: {
                    stability: 0.75,
    ...
    validateVoiceSettings(voiceSettings) {
        return (voiceSettings.stability >= 0 && voiceSettings.stability <= 1 &&
            voiceSettings.similarity_boost >= 0 && voiceSettings.similarity_boost <= 1 &&
            voiceSettings.style >= 0 && voiceSettings.style <= 1 &&
            voiceSettings.speed >= 0.25 && voiceSettings.speed <= 4.0 &&
    ...
    getRecommendedVoiceSettings(storyType, characterPersonality) {
        ...
        switch (storyType.toLowerCase()) {
            case 'adventure':
                return { ...baseSettings, style: 0.6, speed: 1.1 };
            case 'bedtime':
                return { ...baseSettings, style: 0.2, speed: 0.8 };
            case 'mystery':
                return { ...baseSettings, style: 0.3, speed: 0.9 };
            case 'fantasy':
                return { ...baseSettings, style: 0.7, speed: 1.0 };
            default:
                return baseSettings;
        }
    }
...
//# sourceMappingURL=CharacterVoiceManager.js.map