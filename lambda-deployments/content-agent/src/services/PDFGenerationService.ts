import { Story, Character } from '@alexa-multi-agent/shared-types';
...
export class PDFGenerationService {
  ...
  private async generateCoverPage(doc: typeof PDFDocument, request: PDFGenerationRequest): Promise<void> {
  ...
  private async generateStoryPages(doc: typeof PDFDocument, request: PDFGenerationRequest): Promise<void> {
  ...
  private async generateActivitiesPages(doc: typeof PDFDocument, activities: GeneratedActivities): Promise<void> {
    doc.addPage();
  ...
  private async generateBackMatter(doc: typeof PDFDocument, request: PDFGenerationRequest): Promise<void> {
    doc.addPage();
  ...
  private addTextOnlyBeat(doc: typeof PDFDocument, beat: any, textSize: number): void {
    doc.fontSize(textSize)
       .fillColor(this.config.colors.text)
       .text(beat.content, {
         width: this.config.layout.pageWidth - (this.config.layout.margins.left + this.config.layout.margins.right),
