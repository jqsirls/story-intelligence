...
class CharacterVoiceGenerator {
    constructor(logger) {
        this.logger = logger;
        this.voiceDesignService = new VoiceDesignService_1.VoiceDesignService(logger);
        this.voiceRemixingService = new VoiceRemixingService_1.VoiceRemixingService(logger);
    }
    /**
...
//# sourceMappingURL=CharacterVoiceGenerator.js.map