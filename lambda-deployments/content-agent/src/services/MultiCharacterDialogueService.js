...
exports.MultiCharacterDialogueService = void 0;
class MultiCharacterDialogueService {
    constructor(logger) {
        this.elevenLabsApiKey = process.env.ELEVENLABS_API_KEY || '';
        this.logger = logger;
    }
    async generateDialogue(dialogue) {
        try {
    ...
    async generateDialogueFromStory(storyContent, characterName) {
        try {
    ...
    extractDialogueFromStory(storyContent) {
    ...
    getVoiceIdForSpeaker(speaker, characterName) {
    ...
    async uploadDialogueToS3(audioBuffer, characterName, storyId) {
        try {
    ...
    async generateDialogueWithTiming(dialogue) {
        try {
...
exports.MultiCharacterDialogueService = MultiCharacterDialogueService;
//# sourceMappingURL=MultiCharacterDialogueService.js.map