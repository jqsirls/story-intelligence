 ...
 * @returns S3 URL
 */
export function getS3Url(s3Key: string, bucketName?: string): string {
 ...
 */
export function getCdnUrl(s3Key: string, forInternalUse: boolean = false): string {
 ...
 */
export function convertS3UrlToCdn(s3Url: string): string {
