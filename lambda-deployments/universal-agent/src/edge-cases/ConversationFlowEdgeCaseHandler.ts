...
import { ConversationState } from '../conversation/UniversalConversationEngine';
...
export class ConversationFlowEdgeCaseHandler extends EventEmitter {
  ...
  private async requestUserConfirmation(
    ...
    // Return context with confirmation prompt - the conversation engine will handle the actual prompting
    return {
      ...context,
