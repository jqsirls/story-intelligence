...
class DeletionService {
    ...
    async hibernateAccount(userId) {
        try {
            ...
            // Archive to Glacier using S3 Glacier tiering (StorageClass: 'GLACIER')
            // This uses S3's native Glacier integration, which is the recommended approach
            // for archiving data to Glacier storage classes
    ...
    async restoreHibernatedAccount(userId) {
        try {
            ...
            // Restore typically takes 3-5 hours for Standard retrieval tier
