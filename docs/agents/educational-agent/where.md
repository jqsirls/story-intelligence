# Educational Agent - Deployment and Location
...
- **Main File**: `packages/educational-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/educational-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/educational-agent/` (this directory)
- **Agentic UX**: `docs/agents/educational-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-educational-agent-production`
- **Region**: us-east-1
