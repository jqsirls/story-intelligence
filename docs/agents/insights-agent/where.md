# Insights Agent - Deployment and Location
...
- **Main File**: `packages/insights-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/insights-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/insights-agent/` (this directory)
- **Agentic UX**: `docs/agents/insights-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-insights-agent-production`
- **Region**: us-east-1
