# Voice Synthesis - Deployment and Location
...
- **Main File**: `packages/voice-synthesis/src/` (structure to be verified)
- **Code References:**
  - `packages/voice-synthesis/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/voice-synthesis/` (this directory)
- **Agentic UX**: `docs/agents/voice-synthesis.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-voice-synthesis-agent-production`
- **Region**: us-east-1
