# Smart Home Agent - Deployment and Location
...
- **Main File**: `packages/smart-home-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/smart-home-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/smart-home-agent/` (this directory)
- **Agentic UX**: `docs/agents/smart-home-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-smart-home-agent-production`
- **Region**: us-east-1
