# Security Framework - Deployment and Location
...
- **Function Name**: `storytailor-security-framework-production`
...
- **Main File**: `packages/security-framework/src/` (structure to be verified)
- **Code References:**
  - `packages/security-framework/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/security-framework/` (this directory)
- **Agentic UX**: `docs/agents/security-framework.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-security-framework-production`
- **Region**: us-east-1
