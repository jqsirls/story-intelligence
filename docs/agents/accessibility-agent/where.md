# Accessibility Agent - Deployment and Location
...
- **Main File**: `packages/accessibility-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/accessibility-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/accessibility-agent/` (this directory)
- **Agentic UX**: `docs/agents/accessibility-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-accessibility-agent-production`
- **Region**: us-east-1
