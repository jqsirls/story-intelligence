# Therapeutic Agent - Deployment and Location
...
- **Main File**: `packages/therapeutic-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/therapeutic-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/therapeutic-agent/` (this directory)
- **Agentic UX**: `docs/agents/therapeutic-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-therapeutic-agent-production`
- **Region**: us-east-1
