# Content Safety - Deployment and Location
...
- **Function Name**: `storytailor-content-safety-agent-production`
...
### Source Code
- **Package**: `packages/content-safety/`
- **Main File**: `packages/content-safety/src/` (structure to be verified)
- **Code References:**
  - `packages/content-safety/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/content-safety/` (this directory)
- **Agentic UX**: `docs/agents/content-safety.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-content-safety-agent-production`
- **Region**: us-east-1
