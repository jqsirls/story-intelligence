# Knowledge Base Agent - Deployment and Location
...
### Source Code
- **Package**: `packages/knowledge-base-agent/`
- **Main File**: `packages/knowledge-base-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/knowledge-base-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/knowledge-base-agent/` (this directory)
- **Agentic UX**: `docs/agents/knowledge-base-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-knowledge-base-agent-production`
- **Region**: us-east-1
