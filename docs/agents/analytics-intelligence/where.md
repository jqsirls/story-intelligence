# Analytics Intelligence - Deployment and Location
...
- **Function Name**: `storytailor-analytics-intelligence-production`
...
- **Main File**: `packages/analytics-intelligence/src/` (structure to be verified)
- **Code References:**
  - `packages/analytics-intelligence/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/analytics-intelligence/` (this directory)
- **Agentic UX**: `docs/agents/analytics-intelligence.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-analytics-intelligence-production`
- **Region**: us-east-1
