# Character Agent - Deployment and Location
...
- **Function Name**: `storytailor-character-agent-production`
...
### Source Code
- **Package**: `packages/character-agent/`
- **Main File**: `packages/character-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/character-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/character-agent/` (this directory)
- **Agentic UX**: `docs/agents/character-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-character-agent-production`
- **Region**: us-east-1
