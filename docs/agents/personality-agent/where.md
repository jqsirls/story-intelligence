# Personality Agent - Deployment and Location
...
### Source Code
- **Package**: `packages/personality-agent/`
- **Main File**: `packages/personality-agent/src/` (structure to be verified)
- **Code References:**
  - `packages/personality-agent/README.md` - Package documentation

## Where Documentation Exists

### Primary Documentation
- **Agent Documentation**: `docs/agents/personality-agent/` (this directory)
- **Agentic UX**: `docs/agents/personality-agent.md`

## Where to Find Logs

### CloudWatch Logs
- **Log Group**: `/aws/lambda/storytailor-personality-agent-production`
- **Region**: us-east-1
